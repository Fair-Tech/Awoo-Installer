...
namespace inst::ui {
    ...
    void optionsPage::setMenuText() {
        ...
        auto sadModeOption = pu::ui::elm::MenuItem::New("options.menu_items.sad_option"_lang);
        sadModeOption->SetColor(COLOR("#FFFFFFFF"));
        sadModeOption->SetIcon(this->getMenuOptionIcon(inst::config::sadMode));
        this->menu->AddItem(sadModeOption);
